...
//   moveActionEnabled(value, axis=null) {
//     if (value) {
...
//   scaleActionEnabled(value, axis=null) {
//     if (value) {
...
//   rotateActionEnabled(value, axis=null) {
//     if (value) {
